...
DIG_IO_PIN_t DIG_IO_PIN[] = {
  // Name,           PORT,  PIN,         Mode,                 Pull resistor, Speed,                Init
    ...
    {USART_TX,	     GPIOA, GPIO_PIN_9,  GPIO_MODE_AF_PP,  	   GPIO_NOPULL,   GPIO_SPEED_FREQ_HIGH, GPIO_PIN_RESET, GPIO_AF1_USART1},
    {USART_RX,	     GPIOA, GPIO_PIN_10, GPIO_MODE_AF_PP,      GPIO_NOPULL,   GPIO_SPEED_FREQ_HIGH, GPIO_PIN_RESET, GPIO_AF1_USART1},
};
